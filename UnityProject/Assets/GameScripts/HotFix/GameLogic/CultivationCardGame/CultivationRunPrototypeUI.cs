...
namespace GameLogic.Cultivation
{
    public sealed class CultivationRunPrototypeUI : MonoBehaviour
    {
        ...
        private void BuildView()
        {
            ...
            SetLayout(header.gameObject, flexibleWidth: 1, preferredHeight: 76);

            var title = CreateText("Title", header, "仙途·天命", 28, FontStyle.Bold, TextAnchor.MiddleLeft);
            title.color = new Color(0.96f, 0.86f, 0.56f, 1f);
            SetLayout(title.gameObject, flexibleWidth: 1, preferredHeight: 32);

            _stageText = CreateText("StageText", header, string.Empty, 15, FontStyle.Normal, TextAnchor.MiddleLeft);
            ...
            SetLayout(left.gameObject, preferredWidth: 330, flexibleHeight: 1);
            CreateSectionLabel(left, "状态");
            _runText = CreateText("RunText", left, string.Empty, 17, FontStyle.Bold, TextAnchor.UpperLeft);
            _runText.color = Color.white;
            SetLayout(_runText.gameObject, flexibleWidth: 1, preferredHeight: 190);
            CreateSectionLabel(left, "路线");
        ...
        private void Refresh()
        {
            ...
            _stageText.text = FormatStageLine(_run);
