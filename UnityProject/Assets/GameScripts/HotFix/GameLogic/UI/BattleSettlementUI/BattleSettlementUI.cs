...
namespace GameLogic
{
    ...
    class BattleSettlementUI : UIWindow
    {
        ...
        protected override void ScriptGenerator()
        {
            ...
            _panel = RoguelikeUIFactory.CreatePanel("结算成长面板", root, new Vector2(0.12f, 0.14f), new Vector2(0.88f, 0.84f), new Color(0.82f, 0.90f, 1f, 0.97f));
            ...
            RoguelikeUIFactory.CreateImage("结算星辉装饰", _panel, new Vector2(0.04f, 0.84f), new Vector2(0.24f, 0.98f), new Color(0.92f, 0.50f, 1f, 0.34f), RoguelikeUIFactory.BattleLightSprite, Image.Type.Simple, true);
            RoguelikeUIFactory.CreateImage("结算月辉装饰", _panel, new Vector2(0.76f, 0.84f), new Vector2(0.96f, 0.98f), new Color(0.48f, 0.82f, 1f, 0.34f), RoguelikeUIFactory.BattleLightSprite, Image.Type.Simple, true);

            _portrait = RoguelikeUIFactory.CreateImage("角色剪影区", _panel, new Vector2(0.06f, 0.18f), new Vector2(0.30f, 0.78f), new Color(0.78f, 0.90f, 1f, 0.94f), RoguelikeUIFactory.CardFrameSprite, Image.Type.Sliced);
            ...
            RoguelikeUIFactory.CreateImage("角色剪影高光", _portrait, new Vector2(0.08f, 0.66f), new Vector2(0.92f, 0.94f), new Color(0.72f, 0.92f, 1f, 0.30f), RoguelikeUIFactory.BattleLightSprite, Image.Type.Simple, true);
            ...
            _restartButton = RoguelikeUIFactory.CreateButton("重新开始按钮", _panel, "使用永久成长重新开始", new Vector2(0.38f, 0.08f), new Vector2(0.78f, 0.17f), new Color(0.72f, 0.90f, 1f, 0.96f), 18, RoguelikeUIFactory.ButtonFrameSprite);
        }
