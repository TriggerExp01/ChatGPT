...
{
    public sealed class RoguelikeStage62RewardCardRibbonTests
    {
        [Test]
        public void RewardCardTopRibbonUsesSystemG6MetalDivider()
        {
            RoguelikeGame game = RoguelikeGame.Instance;
            game.StartNewRun(62001);
            ...
            using (WindowFixture fixture = WindowFixture.Create("GameLogic.BattleChoiceUI", "BattleChoiceUI"))
            {
                ...
                Image weaponRibbon = FindImage(fixture.Root, "卡牌顶部徽带_1");
        ...
        private sealed class WindowFixture : IDisposable
        {
            ...
            {
                GameObject rootObject = new GameObject(assetName + "Stage62Root", typeof(RectTransform), typeof(Canvas), typeof(GraphicRaycaster));
